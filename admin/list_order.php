...
include('condb.php');
 ...
 $i=1;
?>
<h4 class="">การสั่งซื้อทั้งหมด</h4><br>
        ...
        <tr>
            ...
            <td>
                ...
                <?php  
                    ...
                    if($st==1){
                        echo "<a href='payment.php?o_id=$o_id&do=payment;' class='btn btn-primary btn-sm btn-flat'>เปิดดู</a>";
                    }
                    elseif ($st==2) {
                    ...
                    elseif ($st==4) {
                        echo "<a href='payment_detail.php?o_id=$o_id&do=cancel;' class='btn  btn-sm btn-danger btn-flat'>เปิดดู</a>";
                    }
                    ?>
                </div>
            </td>
